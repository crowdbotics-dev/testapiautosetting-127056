...
## Project Structure
    ...
    ├── testapiautosetting_127056  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_127056`
...
2. Clone this repo and `cd testapiautosetting_127056`
